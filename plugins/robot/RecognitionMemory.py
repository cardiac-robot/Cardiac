...
#         np.set_printoptions(threshold=np.nan)
        ...
        self.analysis_file = "AnalysisFolder/Analysis.json" # file for recording all the values of the recognition (not used, slows the system)
        self.comparison_file = "AnalysisFolder/Comparison.csv" # file for comparing the recognition of face and network, and the quality of estimation
...
# #        self.l_labels = ["Kitchen", "Office"]
    ...
    def CardiacSetFilePaths(self):
        ...
        recog_folder                  = self.CardiacPH.paths['recognition']
        database_folder               = self.CardiacPH.paths['memory_general']
...
#         self.printDB()
    ...
    def updateDB(self, db_file, p_id):
        ...
        if self.isDBinCSV:
            ...
            bla = ""
#             db_handler = db.DbHandler()
#             db_handler.update_person_occurrence(p_id, str(self.occurrences[self.i_labels.index(p_id)]))
...
#         db_handler.save_recognition_data(data)
    ...
    def connectToRobot(self, ip, port=9559, useSpanish = True, isImageFromTablet = True, isMemoryOnRobot = False, imagePath = ""):
    ...
    def useFaceDetectionDB(self, facedb):
        ...
        cur_dir = os.path.dirname(os.path.realpath(__file__)) + "/" + self.recog_folder
        self.face_service.useDatabase(cur_dir + facedb)
    ...
    def runCrossValidationOnRobot(self, num_people, training_folder, test_folder, bin_folder,
        ...
        self.saveFaceDetectionDB(recog_folder)
