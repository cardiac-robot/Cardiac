...
class MainMenuWin(QtGui.QMainWindow):
    ...
    def init_ui(self):
        ...
        self.controlbuttons_main['log_in'].setIconSize(QtCore.QSize(self.winsize_v * 0.4, self.winsize_h * 0.05))
        #
        ...
        self.controlbuttons_main["sign_in"].setIconSize(QtCore.QSize(self.winsize_v * 0.4, self.winsize_h * 0.05))
        #
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(self.PH.paths["img"] + "modalities_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.controlbuttons_main["data"].setIcon(icon)
        self.controlbuttons_main["data"].setIconSize(QtCore.QSize(self.winsize_v * 0.4, self.winsize_h * 0.05))
        #
        ...
        self.controlbuttons_main["settings"].setIconSize(QtCore.QSize(self.winsize_v * 0.4, self.winsize_h * 0.05))
        #
