...
class EndQuestionWin(QtGui.QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        self.label_background.setPixmap(QtGui.QPixmap(self.PH.paths['img'] + "background_questions.png"))
        self.label_background.setScaledContents(True)
        #%%motivation
        self.motivation={}
        self.motivation['label']=QtGui.QLabel(self.centralwidget)
        self.motivation['label'].setGeometry(int(self.winsize_h*0.52),int(self.winsize_v*0.3),int(self.winsize_h*0.45),int(self.winsize_v*0.17))
        self.motivation['label'].setPixmap(QtGui.QPixmap(self.PH.paths['img'] + '/borg_10.png'))
        self.motivation['label'].setScaledContents(True)

        self.motivation['label_inactive']=QtGui.QLabel(self.centralwidget)
        self.motivation['label_inactive'].setGeometry(int(self.winsize_h*0.52),int(self.winsize_v*0.3),int(self.winsize_h*0.45),int(self.winsize_v*0.17))
        ...
        self.motivation['widget'].setGeometry(int(self.winsize_h*0.52),int(self.winsize_v*0.3),int(self.winsize_h*0.45),int(self.winsize_v*0.17))
        ...
        self.satisfaction['label'].setGeometry(int(self.winsize_h*0.52),int(self.winsize_v*0.61),int(self.winsize_h*0.45),int(self.winsize_v*0.17))
        self.satisfaction['label'].setPixmap(QtGui.QPixmap(self.PH.paths['img'] + '/borg_10.png'))
        self.satisfaction['label'].setScaledContents(True)
        self.satisfaction['label_inactive']=QtGui.QLabel(self.centralwidget)
        self.satisfaction['label_inactive'].setGeometry(int(self.winsize_h*0.52),int(self.winsize_v*0.61),int(self.winsize_h*0.45),int(self.winsize_v*0.17))
        ...
        self.satisfaction['widget'].setGeometry(int(self.winsize_h*0.52),int(self.winsize_v*0.61),int(self.winsize_h*0.45),int(self.winsize_v*0.17))
