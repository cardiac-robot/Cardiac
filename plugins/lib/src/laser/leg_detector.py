...
class LegDetector(object):
	...
	#Sample time (default=0.25s)
        ...
        #self.f=open('data_leg_detector.csv','w')
        #data dict
        self.data_processed = {'ldd':0,'cadence':0,'speed':0}
    ...
    #detection process
    def leg_detection_process(self):
        print "habemus data"
        ...
        self.data_processed['ldd']     = self.LDD[-1]
        self.data_processed['cadence'] = self.cadence[-1]
        self.data_processed['speed']   = self.speed[-1]
